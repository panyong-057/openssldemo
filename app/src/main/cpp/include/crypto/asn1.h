 ...
 */
# define ASN1_OBJECT_FLAG_DYNAMIC         0x01/* include.internal use */
# define ASN1_OBJECT_FLAG_CRITICAL        0x02/* critical x509v3 object id */
# define ASN1_OBJECT_FLAG_DYNAMIC_STRINGS 0x04/* include.internal use */
# define ASN1_OBJECT_FLAG_DYNAMIC_DATA    0x08/* include.internal use */
