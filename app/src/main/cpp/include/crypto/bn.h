...
/*
 * Copy the include.internal BIGNUM words into out which holds size elements (and size
...
/*
 * Set the include.internal data words in a to point to words which contains size
 ...
 */
/*
 * |num_words| is int because bn_expand2 takes an int. This is an include.internal
